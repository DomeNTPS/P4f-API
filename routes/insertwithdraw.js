...
router.post('/', function (req, res, next) {
    ...
    //  var sql = `INSERT INTO withdraw(IDEmp,KKS4_Equip_Withdraw,Count_withdraw,Date_Withdraw) VALUES('1379900073717', 'AA',' 1','2020-02-07')`;
     ...
     var sql = `INSERT INTO withdraw(IDEmp,KKS4_Equip_Withdraw,Count_withdraw,Date_Withdraw) VALUES('${IDEmp.ID}', '${req.body.KKS4_Equip_Withdraw}', '${req.body.Count_withdraw}','${req.body.Date_Withdraw}')`;
